...
//------------------------------------------------------------
	...
	//		Input là string toán hạng, hệ cơ số gốc base1 và hệ cơ số đích base2
...
string ConvertBases(string _operand, short int base1, short int base2)
{
	if (_operand == "")
		return "";
	if (base1 == 10 && (isOverFlowDec(_operand)))
	{
		return "Invalid Input ";
	}
		if (base1 == base2)
...
//------------------------------------------------------------
	...
	//Thủ tục đọc dữ liệu từ file in và xuất kết quả ra file out
...
void PROCESS_FROM_FILE(istream& in, ostream& out)
{
	while (!in.eof())
	{
		...
		else
		{
			...
			{
				string _operand = request[3];
				out << NOT(_operand, p1) << endl;
			}
			else
				if (size == 4)
				{
					string _operator = request[3];
					string _operand1 = request[2];
					string _operand2 = request[4];
					if (_operator == "+")
						out << Add(_operand1, _operand2, p1) << endl;
					if (_operator == "-")
						out << Subtract(_operand1, _operand2, p1) << endl;
					if (_operator == "*")
						out << Multiply(_operand1, _operand2, p1) << endl;
					if (_operator == "/")
						out << Divide(_operand1, _operand2, p1) << endl;
					if (_operator == "&")
						out << AND(_operand1, _operand2, p1) << endl;
					if (_operator == "|")
						out << OR(_operand1, _operand2, p1) << endl;
					if (_operator == "^")
						out << XOR(_operand1, _operand2, p1) << endl;
					if (_operator == ">>")
						out << ShiftRight(_operand1, stoi(_operand2), p1) << endl;
					if (_operator == "<<")
						out << ShiftLeft(_operand1, stoi(_operand2), p1) << endl;
					if (_operator == "rol")
						out << ROL(_operand1, stoi(_operand2), p1) << endl;
					if (_operator == "ror")
						out << ROR(_operand1, stoi(_operand2), p1) << endl;
					if (_operator == "<")
						out << isLess(_operand1, _operand2, p1) << endl;
					if (_operator == ">")
						out << isGreater(_operand1, _operand2, p1) << endl;
					if (_operator == "==")
						out << isEqual(_operand1, _operand2, p1) << endl;
					if (_operator == "<=")
						out << isLessOrEqual(_operand1, _operand2, p1) << endl;
					if (_operator == ">=")
						out << isGreaterOrEqual(_operand1, _operand2, p1) << endl;
				}
		}
	}
}
